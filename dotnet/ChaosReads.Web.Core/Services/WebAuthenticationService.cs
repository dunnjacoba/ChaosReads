...
using ChaosReads.Models;
using ChaosReads.Models.Domain;
using ChaosReads.Services.Security;
using System;
...
{
    public class WebAuthenticationService : ChaosReads.Services.IAuthenticationService<int>
    {
        ...
        {
            ChaosReads.Models.Domain.UserBase baseUser = null;
        ...
        {
            ChaosReads.Models.Domain.UserBase baseUser = new UserBase();
